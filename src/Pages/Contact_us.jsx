                            ...
                            <div className="col-lg-7">
                                <form action className>
                                    <div className='d-flex'>
                                        <input type="text" className="w-50 form-control border-0 py-3 mb-4" placeholder="Your Name" />
                                    <input type="email" className="w-50 form-control border-0 py-3 mb-4" placeholder="Enter Your Email" />
                                    </div>
